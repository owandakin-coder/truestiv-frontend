...
const API_URL = import.meta.env.VITE_API_URL || 'https://trustiveai.onrender.com'
    ...
    >
      ...
      <div style={{ width: '100%', maxWidth: 460, padding: '20px', position: 'relative', zIndex: 1 }}>
            ...
            <div key={s} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <div
                style={{
                  ...
                  borderRadius: '50%',
                  background:
                    s <= step ? 'linear-gradient(135deg, #ff6b35, #ff3b3b)' : 'rgba(255,255,255,0.06)',
                  ...
                  fontSize: 12,
                  fontWeight: 700,
                  color: s <= step ? '#fff' : 'rgba(255,255,255,0.2)',
              ...
              {s < 3 && (
                <div
                  style={{
                    ...
                    height: 2,
                    background:
                      s < step ? 'linear-gradient(90deg, #ff6b35, #ff3b3b)' : 'rgba(255,255,255,0.06)',
                    borderRadius: 1,
                    transition: 'all 0.3s'
                  }}
                />
        ...
        >
          ...
          <form
            onSubmit={step < 3 ? handleNext : submit}
